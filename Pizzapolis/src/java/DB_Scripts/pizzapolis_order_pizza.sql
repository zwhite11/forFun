...
CREATE TABLE `order_pizza` (
  ...
  KEY `pizza_id_fk_idx` (`pizza_id`),
  CONSTRAINT `order_summary_fk` FOREIGN KEY (`order_id`) REFERENCES `order_summary` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `pizza_fk` FOREIGN KEY (`pizza_id`) REFERENCES `pizza` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
