...
(function() {
  ...
  StatsController.$inject = ["PlayerDataService", "stats", "name", "shortName"];
  function StatsController(PlayerDataService, stats, name, shortName) {
    var playerStats = this;
    playerStats.stats = stats;
    playerStats.name = name;
    playerStats.shortName = shortName;
